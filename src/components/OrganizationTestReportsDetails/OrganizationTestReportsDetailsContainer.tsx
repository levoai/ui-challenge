...
import OrganizationTestReportsDetails from "./OrganizationTestReportsDetails";
...
const OrganizationTestReportsDetailsContainer: React.FunctionComponent = (props: React.PropsWithChildren<any>) => {
  ...
  return (
    <div className="OrganizationTestReportsDetailsContainer">
      ...
      <OrganizationTestReportsDetails>
...
export default OrganizationTestReportsDetailsContainer;
